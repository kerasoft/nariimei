       ...
       (cartItems.length && shippingAddress) && <React.Fragment >
            ...
            <div className='sm:mt-12 flex justify-center items-center px-4 sm:px-0'>
                <div className='relative sm:min-w-[27.5rem] flex-none w-full p-0 rounded-lg sm:px-12 py-10 sm:bg-slate-800 sm:w-fit'>
                    ...
                    <div className='py-2'>
                      <div onClick={()=>{handlePayMethod(0)}} className='select-none pay-method relative cursor-pointer focus:outline-2 flex text-gray-200 bg-gray-50 justify-center rounded-lg sm:text-lg font-medium italic mb-7 mt-2 px-5 py-2'>
                      ...
                      <div onClick={()=>{handlePayMethod(1)}} className='select-none pay-method relative cursor-pointer focus:outline-2 flex text-gray-200 bg-gray-50 rounded-lg sm:text-lg font-medium italic justify-center'>

...
const ProfileScreen = () => {
    ...
    return (
        <div className='max-w-[1100px] mx-auto py-10 lg:py-16 lg:flex flex-row-reverse gap-8'>
            <div className='relative bg-gray-950 p-4 md:p-6 rounded-lg lg:rounded-xl lg:border-none shadow-sm py-5 lg:w-[25rem]'>
            {userInfo.isAdmin && <span className='uppercase bg-slate-800 text-gray-400 tracking-wider text-[.875rem] rounded-full px-2 py-1 font-semibold absolute left-4 top-0 -translate-y-1/2'>admin</span>}
                ...
                <h6 className='mt-4 text-lg text-gray-200'>{userInfo.email}</h6>

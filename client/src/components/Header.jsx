    ...
    <header className='z-50 top-0 fixed w-full bg-slate-900 shadow-sm border-b-[1px] border-b-[#ccc2] max-h-20 px-6'>
        <nav className='max-w-[1300px] mx-auto py-3 flex items-center gap-5 justify-items-stretch'>
            ...
            <div className='flex justify-end flex-1 md:flex-none'>
                ...
                <a href="/" className='relative mr-3 font-bold md:mr-5'><FiShoppingBag className='text-xl md:text-[1.45rem] text-white'/><span className='absolute bottom-0 w-5 h-5 sm:w-6 sm:h-6 flex justify-center items-center rounded-full bg-black -right-4 -top-3 text-[.875rem] sm:text-base text-gray-200 font-normal'>5</span></a>
